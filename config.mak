...
ifeq ($(CNXTDRIVER),hsf)
CNXTMODS= $(CNXTTARGET)pcibasic2 $(CNXTTARGET)pcibasic3 $(CNXTTARGET)mc97ich $(CNXTTARGET)mc97via $(CNXTTARGET)mc97ali $(CNXTTARGET)mc97ati $(CNXTTARGET)mc97sis $(CNXTTARGET)usbcd2 snd_hda_codec_$(CNXTTARGET)modem $(CNXTTARGET)hda $(CNXTTARGET)soar
endif
ifeq ($(CNXTDRIVER),hcf)
